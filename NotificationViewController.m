...
- (void)viewDidLoad {
    ...
    // add to canvas
    [self.view addSubview:tableView];
    [self->tableView registerNib:[UINib nibWithNibName: @"NotificationTabCell" bundle:nil] forCellReuseIdentifier:@"Cell"];
...
- (IBAction)selectCat:(id)sender {
    ...
    arr = [NSArray arrayWithObjects:@"  All Notifications (3)",nil];
...
- (UITableViewCell *)tableView:(UITableView *)theTableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NotificationTabCell *cell = (NotificationTabCell *)[tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    
    // If there is no cell to reuse, create a new one
    if(cell == nil)
    {
        cell = [[NotificationTabCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentifier];
    }
    ...
    if(indexPath.row ==0)
    {
        ...
        cell.EquipFunctionalLocation.text =@"Northeast reported on substation inspected dated 8/13/14. Leaking visible, left side from front.Aj, please advise.";
