...
- (id)initWithSource:(UIButton *)sender menuHeight:(CGFloat)height itemName:(NSArray *)nameArray
{
    ...
    if(self) {
        ...
        _menuHeight = height;
        _isMenuExpanded = NO;
        [self setUpItemDataSourceWithNames:nameArray ];
...
- (id)initWithWithSource:(UIButton *)sender menuHeight:(CGFloat)height itemNames:(NSArray *)nameArray
{
...
- (id)initWithSource:(UIButton *)sender itemNames:(NSArray *)nameArray
{
...
- (void)setUpItemDataSourceWithNames:(NSArray *)nameArr
{
    int n = nameArr.count;
